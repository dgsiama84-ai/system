...
const [confirmData, setConfirmData] = useState<{name: string, amount: number, category: string, date: string} | null>(null)
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">
            {CATEGORIES.find(c => c.value === confirmData.category)?.label}
          </span>
        </div>
        <div className="flex justify-between">
